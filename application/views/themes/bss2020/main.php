...
<?php
$ci=get_instance();
$_page_directoy=!empty($ci->router->directory)?str_replace('/','-',trim($ci->router->directory,'/'))."-":'';

?>
<body class="bss2020 app-loading <?php echo isLiveEditMode()?' live-edit-mode ':'';  echo getBodyClass(); ?>">
