...
<body class="aps-ctrl-p  skin-<?php echo !empty($_app_color)?$_app_color:"blue"; ?> sidebar-mini <?php  echo  (!empty($_COOKIE['isMBC'])?' sidebar-collapse ':'').' '.(getBodyClass()).' '.(Mapp_setting::GetSettingsValue("is_rtl_admin")=="Y"?"app-rtl":""); ?>">
<?php
    ...
    <div class="wrapper">      
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="<?php echo base_url();?>" target="_blank" class="top-bar-link " ><i class="fa fa-globe"></i> <?php _e("View Site") ; ?></a>
         
          <?php
	          $adminData=GetAdminData();
	          if(!empty($adminData) && $adminData->IsSuperUser()) {
	              ?>
                  <a href="<?php echo base_url('?live=1');?>" target="_blank" class="top-bar-link " ><i class="fa fa-edit"></i> <?php _e("Live Edit") ; ?></a>
	              <?php
	          }
          ?>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li id="app_noti_container" class="dropdown messages-menu notifications-menu2">
                <?php               echo AppNotification::getNotificationHTML();?>
              </li>              
