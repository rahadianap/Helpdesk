                          ...
                          <div class="col-md-4">
                              <div class="panel panel-default">
                                  <div class="panel-heading p-b-5">
                                      <div class="row">
                                          <div class="col-xs-7">
                                              <i class="fa fa-discord c-app"></i> Discord
                                          </div>
                                          <div class="col-xs-5 text-right">
                                              <div class="togglebutton ">
                                                  <input  name="config[is_enable_ds_login]" value="N" type="hidden">
                                                  <label>
                                                      <input  type="checkbox" <?php echo $mainobj->GetPostValue("is_enable_ds_login","N")=="Y"?' checked="checked"':'';?> value="Y" class="has_depend_fld2" id="is_enable_ds_login"  name="config[is_enable_ds_login]" >
                                                  </label>
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <div class="panel-body">
                                      <div class="form-group">
                                          <label class="control-label  " for="login_ds_call_back">Callback/Redirect Domain
                                              <?php
                                              $base_domain =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ?  "https" : "http")."://".(isset($_SERVER['HTTP_HOST'])?$_SERVER['HTTP_HOST']:"");

                                              ?>
                                              <button class="btn btn-xs app-copy-btn" type="button" title="<?php _e("Copy callback url") ; ?>" data-clipboard-text="<?php echo site_url('index.php/social/endpoint');?>?hauth.done=Discord" >
                                                  <i class="fa fa-copy "></i>
                                              </button>
                                          </label>
                                          <div class="form-control bg-disable" style="font-size: 12px; height:auto; min-height: 50px;" id="login_ds_call_back"  ><?php echo site_url('index.php/social/endpoint');?>?hauth.done=Discord</div>
                                          <span class="form-group-help-block"><?php _e("Use this as your callback url into twitter developer panel");?></span>
                                      </div>
                                      <div class="form-group fld-config-is-enable-ds-login fld-config-is-enable-ds-login-y">
                                          <label class="control-label  label-required" for="login_ds_client_id">Client ID</label>
                                          <textarea   class="form-control form-control-2" id="login_ds_client_id" name="config[login_ds_client_id]" placeholder="<?php _e("Client ID"); ?>" data-bv-notempty="true" 	data-bv-notempty-message="Client Id <?php  _e(" is required");?>"><?php echo  $mainobj->GetPostValue("login_ds_client_id")?></textarea>
                                      </div>
                                      <div class="form-group fld-config-is-enable-ds-login fld-config-is-enable-ds-login-y">
                                          <label class="control-label label-required" for="login_ds_secret">Secret</label>
                                          <textarea     class="form-control form-control-2" id="login_ds_secret" name="config[login_ds_secret]" placeholder="<?php _e("Secret"); ?>" data-bv-notempty="true" 	data-bv-notempty-message="Secret <?php  _e(" is required");?>"><?php echo  $mainobj->GetPostValue("login_ds_secret")?></textarea>
                                      </div>
                                  </div>
                              </div>
                          </div>
