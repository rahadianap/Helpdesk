<form method="post" action="<?php echo admin_url("admin-setting-confirm/modify/f");?>" data-beforesend="on_beforesend" data-on-complete="on_complete" class="form app-ajax-form form-horizontal">
	        <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4 label-required" for="use_direct_file"><?php _e("Use Direct File Link"); ?></label>
                        <div class="col-md-8">
                            <div class="togglebutton ">
                                <input  name="config[use_direct_file]" value="N" type="hidden">
                                <label>
                                    <input  type="checkbox" <?php echo $mainobj->GetPostValue("use_direct_file","N")=="Y"?' checked="checked"':'';?> value="Y" class="" id="use_direct_file"  name="config[use_direct_file]" >
                                </label>
                                <span class="form-group-help-block"><?php _e("If you enable it, then it will show direct file link in ticket body instead of secure link");?></span>
                            </div>
