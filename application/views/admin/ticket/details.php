     ...
     if(!empty($ticketObj)){
     	...
     	<div id="ticket_<?php echo $ticketObj->id;?>" class="panel panel-default app-panel-box m-b-10 ticket-panel">
     	  ...
     	  <div class="panel-footer">
     	   	...
     	   	?>
     	   	<li>
     	   	<a class="<?php echo strtolower(substr($file->type, 0,3))=="ima"?"popupimg":"";?>" href="<?php echo Mticket::getFileUrl($file,$ticketObj->ticket_user,$ticketObj);?>" >
                              ...
                              <div class="input-group input-group-sm">
                                  ...
                                  <div class="input-group-addon has-select-input">
                                      <select name="payment_currency">
                                          <?php
                                          $currencies=app_trim(Mapp_setting::GetSettingsValue("payment_currencies","USD"));
