...
class Hybrid_Provider_Adapter {
	...
	public function getAccessToken() {
		...
		return array(
			"access_token" => $this->adapter->token("access_token"), 			"access_token_secret" => $this->adapter->token("access_token_secret"), 			"refresh_token" => $this->adapter->token("refresh_token"), 			"expires_in" => $this->adapter->token("expires_in"), 			"expires_at" => $this->adapter->token("expires_at"), 		);
	}
