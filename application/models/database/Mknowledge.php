    	    ...
    	    foreach ($data as &$d){
    	        ...
    	        if($d->cat_id>0){
        	        if(!empty($categories[$d->cat_id])){
        	            $urltitle=($categories[$d->cat_id]);         	            $d->cat_link='<a class="src-category" href="'.site_url("category/details/{$d->cat_id}/{$urltitle}").'">'.$categories[$d->cat_id].'</a>';;
        	        }
    	        }
