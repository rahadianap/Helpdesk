<?php
	class APPIPdata
	{
		public $ip; 		public $country_code; 		public $country_name; 		public $region_code; 		public $region_name; 		public $city; 		public $zip_code; 		public $time_zone; 		public $latitude; 		public $longitude; 				private static $loadedIpData=[];
		/**
		 * @param string $obj
		 * @return APPIPdata
		 */
